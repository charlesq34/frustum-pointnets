''' Helper class for loading KITTI data '''
...
def viz_kitti_video():
    dataset = kitti_object_video('/home/rqi/Data/2011_09_26/2011_09_26_drive_0023_sync/image_02/data', '/home/rqi/Data/2011_09_26/2011_09_26_drive_0023_sync/velodyne_points/data', '/home/rqi/Data/2011_09_26/')
    print len(dataset)
...
def show_lidar_with_boxes(pc_velo, objects, calib, img_fov=False, img_width=None, img_height=None): 
...
def show_lidar_on_image(pc_velo, img, calib, img_width, img_height):
    ...
    for i in range(imgfov_pts_2d.shape[0]):
        ...
        cv2.circle(img, (int(np.round(imgfov_pts_2d[i,0])), int(np.round(imgfov_pts_2d[i,1]))), 2, color=tuple(color), thickness=-1)
    Image.fromarray(img).show() 
    return img
